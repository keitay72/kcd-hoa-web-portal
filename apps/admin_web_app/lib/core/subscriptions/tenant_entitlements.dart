enum TenantFeature {
  ...
  String get label {
    return switch (this) {
      TenantFeature.residentPortal => 'Customer Portal',
      ...
      TenantFeature.activationCodes => 'Legacy Activation Codes',
      TenantFeature.residentVerification => 'Customer Verification',
...
class TenantSubscriptionEntitlements {
  ...
  TenantEntitlementResult entitlementFor(TenantFeature feature) {
    ...
    return TenantEntitlementResult(
      feature: feature,
      isEnabled: false,
      sourceLabel: _addonCodeForFeature(feature) == null
          ? 'Upgrade required'
          : 'Add-on not enabled',
    );
  }
  ...
  static const customerPortalFeatures = <TenantFeature>[
  ...
  static const addonFeatures = <TenantFeature>[TenantFeature.smsNotifications];
}
...
Set<TenantFeature> _featuresForPlan(String planCode) {
  return switch (planCode) {
    ...
    'metro' ||
    'enterprise' =>
      TenantSubscriptionEntitlements.customerPortalFeatures.toSet(),
    'starter' ||
    'professional' =>
      TenantSubscriptionEntitlements.customerPortalFeatures.toSet(),
