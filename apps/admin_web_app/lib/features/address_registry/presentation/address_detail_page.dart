            ...
            child: address.when(
              data: (item) => Row(
                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _DetailRow(
                                label: 'HOA',
                                value: item.hoaName ?? item.hoaId),
                            _DetailRow(
                                label: 'HOA Code',
                                value: item.hoaCode ?? 'Unknown'),
                  ...
                  const Expanded(flex: 2, child: _CustomerSignupSection()),
                ],
              ),
...
class _CustomerSignupSection extends StatelessWidget {
  const _CustomerSignupSection();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Customers can create an account when this active service location matches the address they enter during signup. The email verification step confirms access before account details are collected.',
